// Zenn / Qiita のブランドアイコン。simple-icons（CC0 1.0）から SVG パスを取り込んだもの。
// 各ロゴの商標はそれぞれのサービスに帰属する。

type IconProps = {
  size?: number
  /** 色は呼ぶ側が決める。ブランドカラーを当てるのは媒体を示す 1 箇所だけ */
  className?: string
}

/** Zenn — simple-icons v16.28.0 (CC0 1.0) より。ブランドカラー #3EA8FF */
export function ZennIcon({ size = 16, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
/** Qiita — simple-icons v16.28.0 (CC0 1.0) より。ブランドカラー #55C500 */
export function QiitaIcon({ size = 16, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
